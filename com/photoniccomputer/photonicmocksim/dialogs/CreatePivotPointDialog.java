                ...
                if(selectedComponent.getComponentType() == OPTICAL_WAVEGUIDE){
                    ...
                    for(ComponentLink compLink : selectedComponent.getComponentLinks()){
                        for(CircuitComponent cComponent : highlightModule.getComponentsMap().values()){
                            System.out.println("2. compLink.getConnectsToComponentNumber():"+compLink.getConnectsToComponentNumber()+" cComponent.getComponentNumber():"+cComponent.getComponentNumber());
                            if(compLink.getConnectsToComponentNumber() == cComponent.getComponentNumber()){
                                System.out.println("3. cComponentNumber:"+cComponent.getComponentNumber()+" compLinkNumber:"+compLink.getLinkNumber());
                                for(InputConnector iConnector : cComponent.getInputConnectorsMap().values()){
                                    System.out.println("4. InputConnector loop cComponentNumber:"+cComponent.getComponentNumber()+" port:"+iConnector.getPortNumber()+" compLink.getConnectsToComponentNumber():"+compLink.getConnectsToComponentNumber());
                                    if(compLink.getConnectsToComponentNumber() == cComponent.getComponentNumber()){//temp new
                                        System.out.println("5. cComponent.getInputConnectorConnectsToComponentNumber(1, iConnector.getPortNumber()):"+cComponent.getInputConnectorConnectsToComponentNumber(1, iConnector.getPortNumber())+" selectedComponentNumber:"+selectedComponent.getComponentNumber());
                                        if(cComponent.getInputConnectorConnectsToComponentNumber(1, iConnector.getPortNumber()) == selectedComponent.getComponentNumber()){
                                            System.out.println("6. compLink.getDestinationPhysicalLocation():"+compLink.getDestinationPhysicalLocation()+" iConnector.getPhysicalLocation():"+iConnector.getPhysicalLocation());
                                            //if(iConnector.getPhysicalLocation().y == compLink.getDestinationPhysicalLocation().y && iConnector.getPhysicalLocation().x == compLink.getDestinationPhysicalLocation().x && cComponent.getComponentNumber() != tempComponentPivotPoint.getComponentNumber()){//temp new trying
                                                System.out.println("7. compLink.getConnectsToComponentPortNumber():"+compLink.getConnectsToComponentPortNumber()+" iConnector.getPortNumber():"+iConnector.getPortNumber());
                                                if(compLink.getConnectsToComponentPortNumber() == iConnector.getPortNumber()){//if right line??
                                                    System.out.println("8. testing for pivot point:"+cComponent.getComponentType()+" on line:"+findIfComponentIsOnSelectedLine(cComponent.getComponentNumber())+" tempComponentPivotPointNumber:"+tempComponentPivotPoint.getComponentNumber());
                                                    if((cComponent.getComponentType() != PIVOT_POINT)||((cComponent.getComponentType() == PIVOT_POINT && findIfComponentIsOnSelectedLine(cComponent.getComponentNumber()) == true) && cComponent != tempComponentPivotPoint)){//new trying cComponent links to a component not a line element!!!
                                                        System.out.println("9. cComponent.getInputConnectorConnectsToComponentNumber(1, iConnector.getPortNumber()):"+cComponent.getInputConnectorConnectsToComponentNumber(1, iConnector.getPortNumber())+" selectedComponent.getComponentNumber():"+selectedComponent.getComponentNumber());
                                                        if(cComponent.getInputConnectorConnectsToComponentNumber(1, iConnector.getPortNumber()) == selectedComponent.getComponentNumber()){
                                                            for(ComponentLink componentLink : iConnector.getComponentLinks()){
                                                                System.out.println("10. compLink.getLinkNumber():"+compLink.getLinkNumber()+" componentLink.getLinkNumber():"+componentLink.getLinkNumber());
                                                                if(compLink.getLinkNumber() == componentLink.getLinkNumber()){
                                                                    System.out.println("above done1 = false in input connector Line:"+cComponent.getComponentNumber());
                                                                    if(done1==false){
                                                                        ...
                                                                        System.out.println("setting destinationPhysicalLocation:"+cComponent.getIConnectorDestinationPhysicalLocation(componentLink.getLinkNumber(), iConnector.getPortNumber()));
                                                                        //start.x = start.x+25;
                                                                        ...
                                                                        System.out.println("Just created optical waveguide StartPt:"+startPt);
                                                                        ...
                                                                        System.out.println("InputConnector loop tempComponentLine:"+tempComponentLine.getComponentNumber()+" start link:"+cLink2.getDestinationPhysicalLocation()+" end Link:"+cLink.getDestinationPhysicalLocation());
                                                                        //tempComponentLine.setPosition(startPt);
                                ...
                                for(OutputConnector oConnector : cComponent.getOutputConnectorsMap().values() ){
                                    System.out.println("OutputConnector loop 1 cComponentNumber:"+cComponent.getComponentNumber()+" oConnector:"+oConnector.getPortNumber()+" compLinkNumber:"+compLink.getLinkNumber());
                                    if(compLink.getConnectsToComponentNumber() == cComponent.getComponentNumber()){//temp new
                                        System.out.println("OutputConnector loop 2 compLink.getConnectsToComponentNumber():"+compLink.getConnectsToComponentNumber());
                                        if(compLink.getLinkNumber() == 1){//temp
                                            System.out.println("OutputConnector loop 3 compLink.getLinkNumber():"+compLink.getLinkNumber());
                                            if(compLink.getDestinationComponentNumber() == cComponent.getOConnectorDestinationComponentNumber(1, oConnector.getPortNumber())){//temp new trying
                                                System.out.println("OutputConnector loop 4 compLink.getDestinationComponentNumber():"+compLink.getDestinationComponentNumber());
                                                if(compLink.getConnectsToComponentPortNumber() == oConnector.getPortNumber()){//if right line??
                                                    System.out.println("OutputConnector loop 5 compLink.getConnectsToComponentPortNumber():"+compLink.getConnectsToComponentPortNumber());
                                                    //if(oConnector.getPhysicalLocation().x == compLink.getDestinationPhysicalLocation().x && oConnector.getPhysicalLocation().y == compLink.getDestinationPhysicalLocation().y){//temp trying
                                                        System.out.println("OutputConnector loop 6 oConnector.getPhysicalLocation():"+oConnector.getPhysicalLocation());
                                                        if(oConnector.getComponentLinks().getFirst().getConnectsToComponentNumber() == selectedComponent.getComponentNumber() ){
                                                            System.out.println("OutputConnector loop 7 oConnector.getComponentLinks().getFirst().getConnectsToComponentNumber():"+oConnector.getComponentLinks().getFirst().getConnectsToComponentNumber());
                                                            ...
                                                            if((cComponent.getComponentType() != PIVOT_POINT)||(cComponent.getComponentType() == PIVOT_POINT && findIfComponentIsOnSelectedLine(cComponent.getComponentNumber()) == true)){//new trying cComponent links to a component not a line element!!!
                                                                if(cComponent.getOutputConnectorConnectsToComponentNumber(1, oConnector.getPortNumber()) == selectedComponent.getComponentNumber()){
                                                                    System.out.println("OutputConnector loop 8 cComponent.getOutputConnectorConnectsToComponentNumber(1, oConnector.getPortNumber()):"+cComponent.getOutputConnectorConnectsToComponentNumber(1, oConnector.getPortNumber()));
                                                                    for(ComponentLink componentLink : oConnector.getComponentLinks()){
                                                                        if(compLink.getLinkNumber() == componentLink.getLinkNumber()){
                                                                            ...
                                                                            System.out.println("modified current line:"+selectedComponent.getComponentNumber()+" startPt:"+startPt+" destinationPhysicalLocation:"+cComponent.getOConnectorDestinationPhysicalLocation(componentLink.getLinkNumber(),oConnector.getPortNumber()));
                                                                            ...
                                                                            if(done1==false){
                                                                                System.out.println("cComponent.getComponentNumber():"+cComponent.getComponentNumber());
                                                                                
                                                                                compLink.setConnectsToComponentNumber(cComponent.getComponentNumber());
                                                                                
                                                                                System.out.println("compLink.setConnectsToComponentNumber:"+compLink.getConnectsToComponentNumber());
                                                                                System.out.println("oConnector.getPortNumber():"+oConnector.getPortNumber());
                                                                                
                                                                                compLink.setConnectsToComponentPortNumber(oConnector.getPortNumber());
                                                                                
                                                                                System.out.println("componentLink.getLinkNumber():"+componentLink.getLinkNumber());
                                                                                
                                                                                compLink.setLinkNumber(componentLink.getLinkNumber());
                                                                                
                                                                                System.out.println("compLink.setLinkNumber:"+compLink.getLinkNumber());
                                                                                ...
                                                                                System.out.println("compLink.getDestinationComponentNumber:"+compLink.getDestinationComponentNumber());
                        ...
                        if(tempComponentLine != null){
                           ...
                           // tempSourceComponent.setIConnectorDestinationComponentNumber(compLink.getLinkNumber(),compLink.getConnectsToComponentPortNumber() ,tempComponentPivotPoint.getComponentNumber());//source Port,destination componentNumber        
                             ...
                             System.out.println("added line Management to tempComponentLine:"+tempComponentLine.getComponentNumber());
                                        ...
                                        if(cKtComponent.getComponentNumber() == compLink.getConnectsToComponentNumber()){
                                            for(InputConnector iConnector : cKtComponent.getInputConnectorsMap().values()){
                                                if(iConnector.getPortNumber() == compLink.getConnectsToComponentPortNumber() ){
                                                    System.out.println("setting inputConnectorConnectstoComponentNumber"+cKtComponent.getInputConnectorConnectsToComponentNumber(1,iConnector.getPortNumber()));
                        ...
                        if(cLinkage1==null &&tempComponentLine != null){
                            for(CircuitComponent cComponent : highlightModule.getComponentsMap().values()){ 
                                ...
                                if(cComponent.getComponentNumber() == compLink.getConnectsToComponentNumber()){
                                     for(InputConnector iConnector : cComponent.getInputConnectorsMap().values()){
                                        if(iConnector.getPortNumber() == compLink.getConnectsToComponentPortNumber() ){
                                            System.out.println("iConnector.getPortNumber():"+iConnector.getPortNumber());
                                            System.out.println("tempComponentLine.getComponentNumber():"+tempComponentLine.getComponentNumber());
                   ...
                   //if(done2==true){
                        ...
                        System.out.println("Adding cLinkage1 to line:"+selectedComponent.getComponentNumber());
                        selectedComponent.addComponentLink(cLinkage1);//cLinkage 1;
                        cLinkage1=null;
                    }
                    System.out.println("Adding cLinkage2 to line:"+selectedComponent.getComponentNumber());
                    selectedComponent.addComponentLink(cLinkage2);//cLinkage2
                    System.out.println("Line:"+selectedComponent.getComponentNumber()+" sourcePhysicalLocation"+selectedComponent.getComponentLinks().get(0).getDestinationPhysicalLocation()+" destinationPhysicalLocation:"+selectedComponent.getComponentLinks().get(1).getDestinationPhysicalLocation());
                   ...
                   if(lineComponent!=null) System.out.println("lineComponent.getPosition():"+lineComponent.getPosition());
                    ...
                    for(CircuitComponent cComp : highlightModule.getComponentsMap().values()){
                        if(cComp.getComponentType() == OPTICAL_WAVEGUIDE){
                            ...
                            System.out.println("Testing Line:"+cComp.getComponentNumber()+" for correct componentLinks first:"+cComp.getComponentLinks().get(0).getDestinationPhysicalLocation()+" second:"+cComp.getComponentLinks().get(1).getDestinationPhysicalLocation());
                    ...
                    for(CircuitComponent comp : highlightModule.getComponentsMap().values()){
                        if(comp.getComponentType() == OPTICAL_WAVEGUIDE){
                            ...
                            System.out.println("---- Line:+"+comp.getComponentNumber()+" ----"
